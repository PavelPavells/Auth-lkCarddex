...
class PriceList extends Component {
  ...
  render() {
    ...
    if(pricelist.data.length === 0 && !isFetching) {
      return <Loader />
    }
    //if (!isLoading) {
    //  return <Loader />;
        ...
        <main className="main-content">
          ...
          <section className="wrapper-table__main">
            <section className="wrapper-table__header">
                {pricelist.data.payload.recordDisplayRules.map((index, key) => { //add .pricelist
                  if(index.visible === 1) {
                    return (
            ...
            <section className="wrapper-table__main-categories">
              ...
              {groupByCategories ? (
                ...
                >
                  {pricelist.data.payload.recordSet.map((index, key) => ( //add .pricelist
